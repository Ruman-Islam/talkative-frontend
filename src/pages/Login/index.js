          ...
          <div className="card flex-shrink-0 w-full max-w-sm">
            <div className='flex justify-center items-center'>
              <div className='w-96 p-7'>
                ...
                <p className="text-neutral">New to Talkative? <Link href='/Register/Index' className='font-bold text-info'>Create New Account</Link></p>
                <div className="divider"> </div>
                <button className='btn btn-primary btn-outline w-full'>Google Login</button>
              </div>
            </div>
          </div>
        </div>
